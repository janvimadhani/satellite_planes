    ...
    for haloID in haloIDs:
        ...
        if len(halo_masses[host_halo_mask]) < 1:
            ...
            if len(g_pxs[within_rad]) < 1:
                ...
                system['sat_iz'] = np.zeros((1))
                    
                system['sat_pxs'] = np.zeros((1))
                system['sat_pys'] = np.zeros((1))
                system['sat_pzs'] = np.zeros((1))
                system['sat_vxs'] = np.zeros((1))
                system['sat_vys'] = np.zeros((1))
                system['sat_vzs'] = np.zeros((1))
                system['sat_rvirs'] = np.zeros((1))
                system['sat_mvirs'] = np.zeros((1))
                system['sat_levels'] = np.zeros((1))

                system['MW_iz'] = np.zeros((1))
                system['MW_px'] = np.zeros((1))
                system['MW_py'] = np.zeros((1))
                system['MW_pz'] = np.zeros((1))
                system['MW_mvir'] = np.zeros((1))
                system['MW_rvir'] = np.zeros((1))
                system['MW_spin'] = np.zeros((1))
                system['MW_lx'] = np.zeros((1))
                system['MW_ly'] = np.zeros((1))
                system['MW_lz'] = np.zeros((1))
                system['MW_vx'] = np.zeros((1))
